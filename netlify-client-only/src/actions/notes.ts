...
export const fetchNotes = () => async (dispatch: Dispatch) => {
  const response = await axios.get<Note[]>('https://gabasau-edit-nyb.herokuapp.com/api/note');
...
export const deleteNote = (id: string) => async (dispatch: Dispatch) => {
  const response = await axios.delete<string>(`https://gabasau-edit-nyb.herokuapp.com/api/note/${id}`);
...
export const patchNote = (note: Note) => async (dispatch: Dispatch) => {
  const response = await axios.patch<Note>(`https://gabasau-edit-nyb.herokuapp.com/api/note/${note.id}`, note);
...
export const postNote = (note: Note) => async (dispatch: Dispatch) => {
  const response =  await axios.post<Note>(`https://gabasau-edit-nyb.herokuapp.com/api/note/`, note);
